/*
This file was intended to be used as a model for a nuron in a nural network.
It includes the main function:

int nuron(const string nuron_name, float var1, float var2, float &outvar)

    int nuron               - returns 0 OR 1; 1 is an error; 0 is success
    const string nuron_name - used as filename and console log name
    float var1              - input 1
    float var2              - input 2
    float &outvar           - outside variable to store output in
...
int main(){
    ...
    nuron("nuron_1", var1, var2, output);
    
    cout << endl << output * 100 << "% True" << endl;
